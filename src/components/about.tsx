...
export const About = () => {
  const renderTestimonial = (testimonials: TestimonialData[]) =>
    testimonials.map(({ id, quote, author, contact }, index) => (
      <AnimatedSection
        delay={index * 0.2}
        key={id}
        className="flex min-h-96 flex-col font-body justify-between gap-y-3 rounded-2xl border-solid border-dark px-8 py-6 odd:bg-accent-primary even:bg-accent-secondary first-of-type:border first-of-type:bg-white">
        <p>"{quote}"</p>
  ...
  return (
    <section id="about">
      ...
      <AnimatedSection className="mb-6 flex flex-col gap-20 md:mb-20 md:flex-row-reverse">
        ...
        <div className="flex flex-col justify-between gap-6 text-dark">
          ...
          <p>
            I am a dedicated designer based in India, and I'm truly passionate about creating intuitive user experiences. Research is my favorite part
            of the design process. I love connecting with diverse people to understand their goals, needs and pain points to create intuitive and
            beautiful solutions. I'm resourceful and love approaching challenges creatively, always excited to take on new projects and deliver my
            best. Outside of design, I enjoy meditating, drawing cute patterns, or spending time in nature.
          </p>
