  ...
  const renderTestimonial = (testimonials: TestimonialData[]) =>
    testimonials.map(({ id, quote, author, contact }) => (
      <div
        ...
        className="font-title flex min-h-96 flex-col justify-between gap-y-3 rounded-2xl border-dark px-8 py-6 odd:bg-accent-primary even:bg-accent-secondary first-of-type:border first-of-type:bg-white">
        <p>"{quote}"</p>
