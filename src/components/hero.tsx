  ...
  return (
    <AnimatedSection id="#" className="flex flex-col items-center font-body md:flex-row md:py-24">
      <div className="mb-24 mt-32 flex flex-col md:mb-0 md:w-full">
        <h1 className="leading-tight sm:leading-40 font-mono text-4xl font-medium md:text-5xl text-ag-dark">Hi, I&apos;m Thushara.</h1>
        <p className="my-12 font-title text-2xl md:text-3xl leading-10 text-ag-grey">
